...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:tarragoReachConnectionString %>" SelectCommand="SELECT [Row], [Email], [FechaCreacion], [Nombre], [Empresa], [Telefono], [Direccion], [Perfil], [Idioma], [Pais], [IdiomaOrig], [EmpresaOrig] FROM [Usuario]"></asp:SqlDataSource>
</asp:Content>
